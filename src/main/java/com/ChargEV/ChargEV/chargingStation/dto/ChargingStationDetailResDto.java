...
public class ChargingStationDetailResDto {
    ...
    @QueryProjection
    public ChargingStationDetailResDto(String name, String statId, String chargerId, String output, String method, String kind, String kindDetail, String address, String location, String note, String limitYn, String limitDetail, String useTime, String updatedDate) {
        this.name = name;
        this.statId = statId;
